...
// Speed é uma palavra reservada, lembre-se disso ou seus players vão sair andando do nada hehe
...
dos booleans é 0, 5 + 0 = 5, então a velocidade vai ser 5 no eixo y e no eixo x, ele vai para a diagonal
...
/* Explicando melhor esse código: é possível fazer operações com booleans, keyboard_check checa se o jogador
está apertando alguma tecla e retorna 0 ou 1, true ou false, com esse retorno posso fazer operações lógicas e,
por incrível que pareça, operações matemáticas também, portanto, posso somar, subtrair, dividir, etc, o resultado boolean.
...
subtrair de 5 em 5 fazendo o personagem ir para cima. Coisa parecida acontece com o eixo x, só que com direita e esquerda.
